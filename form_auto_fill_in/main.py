...
def UHMRF(argv=sys.argv[1:]):
    parser = argparse.ArgumentParser(prog="Answer UHMRF", description="Auto fill in form about 'UTokyo Health Management Report Form'", add_help=True)
    parser.add_argument("--quiet",        action="store_true", help="Whether you want to be quiet or not. (default=False)")
    parser.add_argument("-P", "--params", action=KwargsParamProcessor, help="Specify the kwargs. You can specify by -P username=USERNAME -P password=PASSWORD")
